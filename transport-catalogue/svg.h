...
template <class ObjectType> class PathProps {
public:
...
private:
  ObjectType &AsObjectType() { return static_cast<ObjectType &>(*this); }
...
public:
  ...
  template <typename ObjectType> void Add(ObjectType obj) {
...
public:
  Star(svg::Point center, double outer_radius, double inner_radius,
      ...
      : center_(center), outer_radius_(outer_radius),
        inner_radius_(inner_radius), rays_count_(rays_count) {}
