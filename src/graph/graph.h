...
template <typename Weight>
DirectedWeightedGraph<Weight>::DirectedWeightedGraph(size_t vertex_count) : incidences_(vertex_count) {}
...
template <typename Weight>
typename DirectedWeightedGraph<Weight>::IncidentEdges DirectedWeightedGraph<Weight>::GetIncidentEdges(
