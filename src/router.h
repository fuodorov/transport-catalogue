...
public:
    ...
    void parse_bus_to_edges(Iterator first, Iterator last, const TransportCatalogue &transport_catalogue,
                            const Bus *bus);
...
template <typename Iterator>
void TransportRouter::parse_bus_to_edges(Iterator first, Iterator last, const TransportCatalogue &transport_catalogue,
                                         const Bus *bus) {
