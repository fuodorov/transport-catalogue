    ...
    if (node.is_dict()) {
        ...
        try {
            ...
            for (auto [key, value] : stop_road_map) {
                ...
                distances.push_back({catalogue.get_stop(begin_name), catalogue.get_stop(last_name), distance});
            }
    ...
    if (node.is_dict()) {
        ...
        try {
            ...
            if (rend_map.at("bus_label_offset").is_array()) {
                ...
                rend_set.bus_label_offset_ =
                    std::make_pair(bus_lab_offset[0].as_double(), bus_lab_offset[1].as_double());
            }
            ...
            if (rend_map.at("stop_label_offset").is_array()) {
                ...
                rend_set.stop_label_offset_ =
                    std::make_pair(stop_lab_offset[0].as_double(), stop_lab_offset[1].as_double());
            }
...
void JSONReader::parse_node_make_base(TransportCatalogue &catalogue, map_renderer::RenderSettings &render_settings,
